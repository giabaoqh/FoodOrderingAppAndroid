...
class PayOutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        totalAmount = calculaTotalAmount().toString() + "₫"
    ...
    private fun placeOrder() {
        ...
        orderReference.setValue(orderDetails).addOnSuccessListener {
            ...
            removeItemFromCart()
            addOrderoHistory(orderDetails)
        }
            .addOnFailureListener {
                Toast.makeText(this,"Đặt món thất bại", Toast.LENGTH_SHORT).show()
            }
    }
    private fun addOrderoHistory(orderDetails: OrderDetails){
    ...
    private fun calculaTotalAmount(): Int {
        var totalAmount = 0
